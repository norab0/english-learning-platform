  ...
  private loadMockScores(): void {
    const mockScores: UserScore[] = [
      ...
      },
      {
        ...
        userEmail: 'user@test.com',
        examId: '4',
        examTitle: 'Business English Test',
        score: 82,
        maxScore: 100,
        percentage: 82,
        passed: true,
        completedAt: new Date('2024-09-21T11:45:00'),
        attempts: 1
      },
      {
        userId: '2',
        ...
        percentage: 68,
        passed: false,
        completedAt: new Date('2024-09-20T14:20:00'),
        attempts: 1
      },
      {
        userId: '3',
        ...
        percentage: 91,
        passed: true,
        completedAt: new Date('2024-09-20T09:45:00'),
        attempts: 1
      },
      {
        userId: '3',
        ...
        percentage: 78,
        passed: true,
        completedAt: new Date('2024-09-20T16:30:00'),
        attempts: 1
      },
      {
        userId: '3',
      ...
      },
      {
        ...
        percentage: 45,
        passed: false,
        completedAt: new Date('2024-09-21T13:20:00'),
        attempts: 1
      },
      {
        userId: '4',
        ...
        percentage: 73,
        passed: true,
        completedAt: new Date('2024-09-21T15:45:00'),
        attempts: 2
      }
    ];
